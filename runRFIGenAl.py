...
pl.subplot(412)
pl.imshow(np.log10(np.abs(data*x.initWalker)),aspect='auto',interpolation='none')
pl.subplot(413)
x.plotRFIMap(live=False)
pl.subplot(414)
pl.imshow(np.log10(np.abs(sfft.fftshift(sfft.fft(data*x.initWalker)))),aspect='auto',interpolation='none')
