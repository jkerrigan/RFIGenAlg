...
for i in range(epochs):
    ...
    if np.log10(x.epochScore[i]) < 4.0:
        break
...
pl.subplot(414)
pl.imshow(np.log10(np.abs(sfft.fftshift(sfft.fft(data*x.initWalker,axis=1),axes=1))),aspect='auto',interpolation='none',cmap='jet')
